...
const audioUrl = new URL(require("53ed88563664c73b"));
const containerRef = document.getElementById("happy-container");
console.log(containerRef);
let count = 1;
containerRef.addEventListener("click", ()=>{
    // Crear un nuevo elemento div para el corazón
    const heartElement = document.createElement("div");
    heartElement.id = "heart";
    // Crear el elemento svg
    const svgElement = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    svgElement.id = "heart-svg";
    svgElement.setAttribute("viewBox", "0 0 600 500");
    // Crear el elemento path y establecer su atributo d
    const pathElement = document.createElementNS("http://www.w3.org/2000/svg", "path");
    pathElement.setAttribute("d", "M300,150 C500,10 600,300 300,400 C0,300 100,10 300,150");
    // Agregar el elemento path al elemento svg
    svgElement.appendChild(pathElement);
    // Crear el elemento div para bubble-dummy
    const bubbleDummyElement = document.createElement("div");
    bubbleDummyElement.classList.add("bubble-dummy");
    // Agregar los elementos al elemento heart
    heartElement.appendChild(svgElement);
    heartElement.appendChild(bubbleDummyElement);
    containerRef.appendChild(heartElement);
    // Generar un tamaño aleatorio para el corazón
    const heartSize = (0, _animejsDefault.default).random(0.4, 1.2);
    // Obtener una posición aleatoria dentro del contenedor
    const containerWidth = containerRef.offsetWidth;
    const containerHeight = containerRef.offsetHeight;
    const heartX = Math.random() * (containerWidth - heartElement.offsetWidth);
    const heartY = Math.random() * (containerHeight - heartElement.offsetHeight);
    // Establecer la posición inicial del corazón
    heartElement.style.left = `${heartX}px`;
    heartElement.style.top = `${heartY}px`;
    // Generar una inclinación aleatoria para el corazón
    const heartRotation = (0, _animejsDefault.default).random(-10, 10);
    // Configurar la animación de rotación
    (0, _animejsDefault.default)({
        targets: heartElement,
        rotate: {
            value: `${heartRotation}deg`,
            duration: 1000,
            easing: "easeInOutSine"
        },
        loop: false
    });
    // Configurar la animación de pulso
    ...
    // Agregar animación de "toque" al contenedor
    (0, _animejsDefault.default)({
        targets: "#touch",
        scale: [
            {
    ...
    // Agregar uno más al contador
    count++;
    console.log(count);
    if (count >= 20) {
        console.log("tapar pantalla");
        createOverlay();
        // Animar la aparición del objeto
        // Animar la aparición del objeto con efecto sorprendente
        (0, _animejsDefault.default)({
            targets: "#overlay",
            translateX: [
                0,
...
function createOverlay() {
    // Crear el elemento div del overlay
    ...
    const heartElement = document.createElement("div");
    heartElement.id = "heart";
    heartElement.classList.add("main-heart");
    // Crear el elemento svg
    const svgElement = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    svgElement.id = "heart-svg";
    svgElement.setAttribute("viewBox", "0 0 600 500");
    ...
    heartElement.appendChild(svgElement);
    heartElement.appendChild(bubbleDummyElement);
    overlayElement.appendChild(heartElement);
    //animacion fuego
    // Crear el elemento principal fire-effect
    const fireEffectElement = document.createElement("div");
    fireEffectElement.classList.add("fire-effect");
    // Crear el elemento fire-glow
    const fireGlowElement = document.createElement("div");
    fireGlowElement.classList.add("fire-glow");
    // Crear el elemento fire-sparks
    const fireSparksElement = document.createElement("div");
    fireSparksElement.classList.add("fire-sparks");
    // Agregar los elementos al documento
    fireEffectElement.appendChild(fireGlowElement);
    fireEffectElement.appendChild(fireSparksElement);
    overlayElement.appendChild(fireEffectElement);
    //texto
    const divElement = document.createElement("div");
    divElement.id = "my-heart";
    divElement.textContent = "Mi coraz\xf3n es tuyo!!";
    overlayElement.appendChild(divElement);
    // Agregar el elemento al body
    document.body.appendChild(overlayElement);
    // Generar un tamaño aleatorio para el corazón
    const heartSize = (0, _animejsDefault.default).random(0.8, 1);
    // Configurar la animación de pulso
    (0, _animejsDefault.default).timeline({
        targets: ".main-heart",
        loop: true
...
},{"animejs":"jokr5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","53ed88563664c73b":"kxNcB"}],"jokr5":[function(require,module,exports) {
/*
 * anime.js v3.2.1
...
},{}],"kxNcB":[function(require,module,exports) {
module.exports = require("941ed4f8317e376d").getBundleURL("3gKDs") + "heart.502de168.mp3" + "?" + Date.now();

},{"941ed4f8317e376d":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["lmKb7","adjPd"], "adjPd", "parcelRequire94c2")
